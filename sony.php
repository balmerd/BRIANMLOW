			...
			<div class="col-md-6">
				<div id="artform-project-description">
					<div class="entry-content">
						<p>&nbsp;</p>
						<p>I was tasked with the concept, design and development for a newsletter that Sony would send to its subscribers on a quarterly basis, showcasing its upcoming productions at the Sony Centre.</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
					</div>
				</div>
