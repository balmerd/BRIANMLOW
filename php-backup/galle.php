			...
			<div class="col-md-6">
				<div id="artform-project-description">
					<div class="entry-content">
						<p>&nbsp;</p>
						<p>Vanessa approached me with a request for a self-promo piece that she could distribute to potential clients. We ultimately decided on a four-panel, double-sided, perfed piece that could double as a CD insert in the future. The strategy behind the perforations is - one printed piece could be distributed to four contacts within the same organization.</p>
					</div>
				</div>
			</div>
			<div class="col-md-6">
